...
<section class="pb-5 home-section-top" style="background-image:url('https://magical-brown.65-108-72-55.plesk.page/assets/website/arabic/img/PropertyDefault.svg'); background-position: center center;"> 
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="../image/sliderHome.svg" alt="Los Angeles" style="width:100%;" href="#">
      </div>

      <!-- <div class="item">
        <img src="../image/sliderHome.svg" alt="Chicago" style="width:100%;" href="#">
      </div>
    
      <div class="item">
        <img src="../image/sliderHome.svg" alt="New york" style="width:100%;" href="#">
      </div> -->
    </div>
  </div>
</div>
...
<section class="pt-5 pb-5 serverHome">
  ...
  <div class=" mr-5 ml-5 pt-5 d-flex" >
    <div class="col-sm-3 " >    
  ...
  <div class="d-flex justify-content-center">
    <button class="col-s-12 bg-dark font-weight-bold text-light datepicker mt-5 text-center w-25 ">اشترك الآن</button>
  </div>
</section>
  ...
  <div class=" d-flex align-items-center justify-content-evenly p-5 planHome" >
    ...
    <div class="border text-center h-100 pb-5  "    > 
      ...
      <div class="text-right">
        <button class="bg-dark font-weight-bold text-light datepicker mt-2 w-100  "> اشترك الآن </button>
      </div>
    </div>
